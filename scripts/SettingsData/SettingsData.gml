...
/*
add_setting("general", "chat_fliter", new SettingsData(true, SETTINGS_TYPE.SWITCH));
*/
...
if (_frequency > 60)
{
	...
	if (_frequency >= 90)
	{
		...
		if (_frequency >= 120)
		{
			_data.add_values(120);
			
			if (_frequency >= 144)
			{
				_data.add_values(144);
				
				if (_frequency >= 240)
				{
					_data.add_values(240);
				}
			}
		}
	}
