function string_profanity(_string)
{
    ...
    for (var j = 1; j <= _string_length; ++j)
    {
        ...
        for (var i = 0; i < __profanity_extreme_length; i += 2)
        {
            var _profanity = __profanity_extreme[i];
            var _profanity_length = __profanity_extreme[i + 1];
        ...
        for (var i = 0; i < __profanity_length; i += 2)
        {
            var _profanity = __profanity[i];
            var _profanity_length = __profanity[i + 1];
